...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\DELL\\Desktop\\Lab_in_Psych\\Intentional_binding_task\\intentional_binding_exp_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=33.0, method='random', 
        ...
        trialList=data.importConditions('intentional_binding_conditions.csv'),
