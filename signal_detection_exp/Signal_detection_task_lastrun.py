...
expName = 'Signal_detection_task'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\DELL\\Desktop\\Lab_in_Psych\\signal_detection_exp\\Signal_detection_task_lastrun.py',
