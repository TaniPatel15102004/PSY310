...
expName = 'motor_sequence_learning_task'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\DELL\\Desktop\\Lab_in_Psych\\motor_sequence_learning\\motor_sequence_learning_task_lastrun.py',
