...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\DELL\\Desktop\\Lab_in_Psych\\adaptive_staircase_exp\\adaptive_staircase_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisStair in stair:
        ...
        # Run 'Begin Routine' code from fifty_fifty
        ...
        # Run 'End Routine' code from fifty_fifty
